...
/*
----------------------------------------------------------
于 2025/2/14 修改，并且重新命名库文件为ICMaker_Servo
----------------------------------------------------------
*/
/* 
...
#ifndef ICMaker_ESP32_Servo_h
#define ICMaker_ESP32_Servo_h
...
public:
	...
	/*简洁初始化，不需要调用allocateTimer
	* 只需要引脚号，最大最小值分别为544和2400
	* 频率为50Hz
	* @param pin 引脚号
	*/
	void begin(int pin);
	/*初始化，不需要调用allocateTimer
	* 只默认频率为50Hz
	* @param pin 引脚号
	* @param min 最小值
	* @param max 最大值
